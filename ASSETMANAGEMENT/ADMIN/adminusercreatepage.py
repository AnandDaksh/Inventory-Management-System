...
@author: tanvi
'''
from tkinter import messagebox, Toplevel, Label, Entry, Button,Text,ttk
import psycopg2
def createuser():
    def save_user():
    ...
    label_id_name.pack()
    id_name_entry = Entry(user_window)
    id_name_entry.pack()
