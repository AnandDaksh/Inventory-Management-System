...
def editinventries():
    try:
        ...
        def update_inventory(event):
            ...
            entry_serial_number = Entry(update_window)
            ...
            entry_model_number = Entry(update_window)
            ...
            entry_model_name = Entry(update_window)
            ...
            entry_date_of_arrival = Entry(update_window)
        ...
        search_label = Label(inventory_window, text="Enter Serial Number:")
        search_label.pack()
        search_entry = Entry(inventory_window)
        search_entry.pack()
        search_button = Button(inventory_window, text="Search", command=search_inventory)
        search_button.pack()
